...
function MoonIcon() {
  return (
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <linearGradient id="v6-moon-bg" x1="12%" y1="6%" x2="92%" y2="100%">
          <stop offset="0%" stopColor="#B69CFF" />
          <stop offset="100%" stopColor="#7B5CFF" />
        </linearGradient>
        <linearGradient id="v6-moon-shape" x1="20%" y1="10%" x2="80%" y2="100%">
          <stop offset="0%" stopColor="#FFFFFF" stopOpacity="0.95" />
          <stop offset="100%" stopColor="#E2D6FF" stopOpacity="0.9" />
        </linearGradient>
      </defs>
      <circle cx="32" cy="32" r="30" fill="url(#v6-moon-bg)" />
      <path
        d="M40.5 19c-.5 0-1 .03-1.5.08a14 14 0 0 0 6.4 23.43A15 15 0 1 1 40.5 19Z"
        fill="url(#v6-moon-shape)"
      />
...
function FocusIcon() {
  return (
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <linearGradient id="v6-focus-bg" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#FFD27A" />
          <stop offset="100%" stopColor="#FF8A4C" />
        </linearGradient>
      </defs>
      <circle cx="32" cy="32" r="30" fill="url(#v6-focus-bg)" />
...
function SleepIcon() {
  return (
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <linearGradient id="v6-sleep-bg" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#7DD3FC" />
          <stop offset="100%" stopColor="#3B82F6" />
        </linearGradient>
      </defs>
      <circle cx="32" cy="32" r="30" fill="url(#v6-sleep-bg)" />
...
function FootnoteText({ children }: { children: string }) {
  return <p className="smpv6-footnote">{children}</p>
}
...
export default function ScenarioModePageV6() {
      ...
      context={
        <>
          ...
          <div
            ...
            className="smpv6-rail smpv6-hide-scrollbar"
            role="list"
            aria-label="情景模式卡片列表"
          >
            {CARDS.map((card) => (
          ...
          <div className="smpv6-dots" role="tablist" aria-label="情景模式分页">
            {CARDS.map((card, idx) => (
              <span
                key={card.id}
                role="tab"
      ...
      listGroup={
        <>
          ...
          <div className="rounded-[20px] overflow-hidden" style={{ background: CARD_BG }}>
            ...
            <button type="button" className="smpv6-add-btn" onClick={() => {}}>
              添加条件
            </button>
          </div>
